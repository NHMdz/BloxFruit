local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/daucobonhi/Test/refs/heads/main/main.lua"))()
    local Window = Fluent:CreateWindow({
    Title = "Metal Hub" ,
    SubTitle = "Beta",
    TabWidth = 140,
    Size = UDim2.fromOffset(600, 280),
...
local Tabs = {
    About = Window: AddTab({ Title = "• information", Icon = "crown" }),
	Settings = Window:AddTab({ Title = "• Settings", Icon = "settings" }),
	Main = Window:AddTab({ Title = "• Auto Farm", Icon = "home" }),
   Qs = Window:AddTab({ Title = "• Item Quest", Icon = "arrow-up-down" }),
    Se = Window:AddTab({ Title = "• Sea Event", Icon = "sailboat" }),   
   spl= Window:AddTab({ Title = "• Player Start", Icon = "user" }),   	
	...
	De = Window:AddTab({ Title = "• Fruit blox", Icon = "banana" }),    
...
do
    ...
    function Tween(Pos)
        ...
        pcall(function()
            tween = game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart,
                TweenInfo.new(Distance / 370, Enum.EasingStyle.Linear), {
                    CFrame = Pos
                })
        end)
        tween:Play()
   ...
   Tabs.About:AddButton("JOIN MY DISCORD")
   function()
    Setclipboard("https://discord.com/invite/5Fk7GhBqEk")
   end()
